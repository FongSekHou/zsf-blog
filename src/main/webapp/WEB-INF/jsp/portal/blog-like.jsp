...
<script>
    ...
    function splicePaginationContent(page) {
        ...
        if (page.currentPage == 1) {
            ...
            contentBar += '<li><a href="#" onclick="queryLikeBlogs(' + (page.currentPage - 1) + ')"> << </a></li>';
        }
        for (var i = 0; i < page.pageBar.length; i++) {
            ...
            contentBar += '><a href="#" onclick="queryLikeBlogs(' + page.pageBar[i] + ')">' + page.pageBar[i] + '</a></li>';
        }
    ...
    function queryLikeBlogs(currentpage) {
        $.ajax({
            url: "${pageContext.request.contextPath}/blog/queryLikeBlogs",
            type: "post",
            data: {
    ...
    $.getJSON("${pageContext.request.contextPath}/blog/loadLike", function (userIndexVO) {
