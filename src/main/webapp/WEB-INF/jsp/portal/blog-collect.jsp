        ...
        <div class="home-personal">
            <div class="home-personal-msg">
                ...
                <div class="home-personal-footer">
                    ...
                    <div style="color: #ff633c;" class="article-msg"
...
<script>
    ...
    function splicePaginationContent(page) {
        ...
        if (page.currentPage == 1) {
            ...
            contentBar += '<li><a href="#" onclick="queryCollectBlogs(' + (page.currentPage - 1) + ')"> << </a></li>';
        }
        for (var i = 0; i < page.pageBar.length; i++) {
            ...
            contentBar += '><a href="#" onclick="queryCollectBlogs(' + page.pageBar[i] + ')">' + page.pageBar[i] + '</a></li>';
        }
    ...
    function queryCollectBlogs(currentpage) {
        $.ajax({
            url: "${pageContext.request.contextPath}/blog/queryCollectBlogs",
            type: "post",
            data: {
    ...
    $.getJSON("${pageContext.request.contextPath}/blog/loadCollect", function (userIndexVO) {
        if(typeof page == "string"){
            window.location.href = "${pageContext.request.contextPath}/user/login?flag=true";
            return;
        }
