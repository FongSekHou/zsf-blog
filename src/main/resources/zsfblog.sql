...
CREATE TABLE `t_user` (
  ...
  `iconpath` varchar(255) DEFAULT '/icon/default.jpg',
...
CREATE TABLE `t_notice` (
  ...
  `collection_id` int(11) DEFAULT NULL COMMENT '收藏博客的博客id',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  ...
  CONSTRAINT `fk_notice_blogid_blog_id` FOREIGN KEY (`blog_id`) REFERENCES `t_blog` (`id`),
  CONSTRAINT `fk_notice_collectionid_collection_id` FOREIGN KEY (`collection_id`) REFERENCES `t_collection` (`id`),
  CONSTRAINT `fk_notice_commentid_comment_id` FOREIGN KEY (`comment_id`) REFERENCES `t_comment` (`id`),
  CONSTRAINT `fk_notice_userid_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
